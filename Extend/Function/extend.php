...
function ubb($Text) {
  ...
  // By Legolas 2016-06-27 10:38
  $Text=preg_replace_callback("/\[colorTxt\](.+?)\[\/colorTxt\]/is",function ($match){return color_txt($match[1]);},$Text);
  //$Text=preg_replace("/\[emot\](.+?)\[\/emot\]/eis","emot('\\1')",$Text);
  //兼容php7修复
  // By Legolas 2016-06-27 10:39
  $Text=preg_replace_callback("/\[emot\](.+?)\[\/emot\]/is",function ($match){return emot($match[1]);},$Text);
  ...
  // By Legolas 2016-06-27 10:42
  $Text=preg_replace_callback("/\[code\](.+?)\[\/code\]/is",function ($match){return highlight_code($match[1]);}, $Text);
  //$Text=preg_replace("/\[php\](.+?)\[\/php\]/eis","highlight_code('\\1')", $Text);
  // By Legolas 2016-06-27 10:44
  $Text=preg_replace_callback("/\[php\](.+?)\[\/php\]/is",function($match){return highlight_code($match[1]);}, $Text);
